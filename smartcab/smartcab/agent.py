...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.7):
        ...
        ['right','left','forward'],
        ['green','red'],
        ['right','left','forward',None],
        ['right','left','forward',None],
        ['right','left','forward',None]
        ]

        self.action_init = dict((key, 0.0) for key in self.valid_actions)
        for state_row in product(*self.states):
            self.Q[state_row] = self.action_init.copy()
    ...
    def createQ(self, state):
        ...
        if not state in self.Q:
            self.Q[state] = self.action_init.copy()
