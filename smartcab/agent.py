...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.7):
        ...
        # Set parameters of the learning agen
        ...
        #when learning is true, intitialize step value.
        #when learning is true, intitialize states value.
        #I refer to this link to learn how to use python get combinations
        #https://stackoverflow.com/questions/798854/all-combinations-of-a-list-of-lists
        if self.learning:
            self.step = 1
            row1 = ['right','left','forward']
            row2 = ['green','red']
            row3 = ['right','left','forward',None]
            row4 = ['right','left','forward',None]
            row5 = ['right','left','forward',None]
            self.rows = [row1,row2,row3,row4,row5]
            for state in itertools.product(*self.rows):
                self.Q[state] = {'forward':0.0, None:0.0, 'right':0.0,'left':0.0}
